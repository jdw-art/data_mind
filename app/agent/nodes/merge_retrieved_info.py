...
async def merge_retrieved_info(
    ...
    try:
        ...
        # 如果相关字段没有被字段召回命中，就从 Meta Mysql里按 id 查出来补进上下文
        ...
        # 字段取值召回命中的是 column_id + value，例如dim_region.region_name.华北
        ...
        # 所以这里先把分散的字段按table_id 归到各自所属表下面
